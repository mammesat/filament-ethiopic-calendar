...
function evaluateEmptyDays(year, month, t) {
  ...
  console.log(`t=${t} Y=${year} M=${month}: Day 1 is ${firstDay}. ` +
    `Proper: ${emptyProper}, Old: ${emptyOld}, Clamped: ${emptyClamped}`);
}

console.log("=== Nehase ===");
evaluateEmptyDays(2018, 10, 1); // Nehase is month 10 (0-indexed)
console.log("=== Pagume ===");
evaluateEmptyDays(2018, 11, 1); // Pagume is month 11? Wait, 13th month is 12 (0-indexed)
evaluateEmptyDays(2018, 12, 1); // Pagume is month 12
