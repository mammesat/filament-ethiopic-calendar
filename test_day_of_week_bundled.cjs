...
var date = (0, import_dayjs.default)("2026-04-21");
var ethDate = date.toCalendarSystem("ethiopic");
console.log("Original EthDate:", ethDate.year(), ethDate.month(), ethDate.date(), "DayOfWeek:", ethDate.day());
var ethDateSetDay1 = ethDate.date(1);
console.log("EthDate set to day 1:", ethDateSetDay1.year(), ethDateSetDay1.month(), ethDateSetDay1.date(), "DayOfWeek:", ethDateSetDay1.day());
