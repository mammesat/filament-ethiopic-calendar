...
var EthiopicCalendarSystem = class extends import_CalendarSystemBase.default {
  constructor(t = "en") {
    ...
    this.monthNamesLocalized = (0, import_IntlUtils.generateMonthNames)(t, "ethiopic", this.firstMonthNameEnglish);
  }
  monthNames(locale = "en", cal = "ethiopic", first = "Meskerem") {
    return (0, import_IntlUtils.generateMonthNames)(locale, cal, first);
  }
...
var focusedDate = (0, import_dayjs.default)().toCalendarSystem("ethiopic");
var focusedMonth = null;
var focusedYear = null;
console.log("Panel opens. focusedDate:", `Y=${focusedDate.year()} M=${focusedDate.month()} D=${focusedDate.date()}`);
var r1 = focusedDate.month();
var s1 = focusedDate.year();
