...
/**
 * Pure Ethiopic ↔ Gregorian date conversion service.
 *
 * This class handles ONLY calendar arithmetic via Julian Day Number (JDN).
 * No formatting, no display logic, no localization.
 */
final class EthiopicCalendarService implements CalendarAdapterInterface
{
